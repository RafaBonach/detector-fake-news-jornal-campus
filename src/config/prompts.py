...
limitante = "Você receberá exatamente 362 notícias. Sua resposta DEVE conter exatamente 157 números. Se retornar menos ou mais que 157 classificações, sua resposta estará incorreta."
